function getShellNotice(){
  return document.getElementById("clientShellNotice");
}

export function clearClientNotice(){
...
export function showClientNotice(message, kind = "info"){
  const el = getShellNotice();
  if(!el) return;
...
export function bindClientInlineNotice(targetId){
